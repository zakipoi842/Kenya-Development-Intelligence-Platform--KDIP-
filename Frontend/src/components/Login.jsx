            ...
            <div>
              ...
              <div className="mt-16">
                ...
                <p className="mt-5 text-emerald-200 text-base leading-7 max-w-lg">
                  Access your account to track development projects, monitor budget utilization,
        ...
        <div className="p-6 sm:p-10 lg:p-14 flex items-center">
          <div className="w-full max-w-md mx-auto">
            ...
            <p className="mt-3 text-gray-500 leading-6">
              Please enter your details to access your account and track development projects.
            </p>
